...
<body>
    ...
    <?php
        ...
        if(!$_GET){
            header("Location: profesores.php?pagina=1");
        }
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                    <a class="page-link" href="profesores.php?pagina=<?php echo $_GET['pagina']-1; ?>">
                        Previous
                    </a>
                </li>
                <?php for($p=0; $p<$paginas; $p++):?>    
                <li class="page-item  <?php echo $_GET['pagina'] == $p+1 ? 'active' : '' ?> ">
                        <a class="page-link" href="profesores.php?pagina=<?php echo $p+1; ?>">
                            <?php echo $p+1; ?>
                        </a>
                </li>
                <?php endfor ?>
