...
<body>
    ...
    <header class="masthead" style="background-image:url('assets/img/home-bg.jpg');">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto" style="height: 269px;">
                    <div class="site-heading" style="height: 74px;"><a href="settings.html"><img class="rounded-circle img-fluid shadow" src="assets/img/tyler.jpg" style="width: 200px; height: 200px;"></a></div>
                </div>
            </div>
        </div>
    </header>
